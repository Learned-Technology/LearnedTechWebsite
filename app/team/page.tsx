...
import { TeamsData } from '@statics/local-data';
...
export default async function Team() {
  ...
  const { items: volunteers } = await wixClient.items
    ...
    .find();
    // console.log("items from wix: ", team)
    ...
    <div className="relative" data-testid={testIds.TEAM_PAGE.CONTAINER}>
      ...
      <div className="max-w-7xl mx-auto mt-[-120px] relative bg-white px-8 sm:px-20">
        ...
        <p className="pt-6 max-w-3xl text-sm text-center mx-auto">
          Learned Tech is more than an organization. It is a family of
        ...
        <p className="pt-6 max-w-3xl text-sm text-center mx-auto">
          Learned Tech is powered by the passion and dedication of our
